...
#measurement_2_feature_concept_ids = load(open(measurement_2_concept_ids_filename, "rb"))
...
#best_n_features_selected_measurement_2 = load(open(best_n_features_selected_measurement_2_filename, "rb"))
...
#        subm = measurement_2.query('measurement_concept_id in @i')
...
#X_measurement_selected_2 = X_measurement_2[:, 0:best_n_features_selected_measurement_2]
