...
n_iterations = int(n_features_x_min / feature_step_size)
max_auprc = 0
...
dump(measurement_feature_concept_ids_selected, measurement_concept_ids_filename)
...
n_iterations = int(n_features_x_condition / feature_step_size)
max_auprc = 0
...
dump(condition_feature_concept_ids_selected, condition_concept_ids_filename)
...
n_iterations = int(n_features_x_observation / feature_step_size)
max_auprc = 0
...
dump(observation_feature_concept_ids_selected, observation_concept_ids_filename)
...
n_iterations = int(n_features_x_device_exposure / feature_step_size)
max_auprc = 0
...
dump(device_exposure_feature_concept_ids_selected, device_exposure_concept_ids_filename)
...
n_iterations = int(n_features_x_drug_exposure / feature_step_size)
max_auprc = 0
...
dump(drug_exposure_feature_concept_ids_selected, drug_exposure_concept_ids_filename)
...
n_iterations = int(n_features_x_procedure / feature_step_size)
max_auprc = 0
...
dump(procedure_feature_concept_ids_selected, procedure_concept_ids_filename)
...
n_iterations = int(n_features_x_visit / feature_step_size)
max_auprc = 0
...
dump(visit_feature_concept_ids_selected, visit_concept_ids_filename)
...
X_selected_os, Y_os = sm.fit_resample(X_selected, Y)

print(datetime.now())
print("model training")

clf = LogisticRegression(solver='saga').fit(X_selected_os, Y_os)
