...
#clf = GridSearchCV(mlp, parameters, n_jobs=4, verbose=1, scoring=auprc_score, cv=3)
clf = RandomizedSearchCV(mlp, parameters, random_state=0, n_iter=100, n_jobs=4, verbose=1, scoring=auprc_score, cv=3)
