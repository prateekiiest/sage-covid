...
#measurement_2_concept_ids_filename = "/model/measurement_2_concept_ids.list"
...
#measurement_2 = measurement.loc[(measurement['measurement_concept_id']== 3042596) | (measurement['measurement_concept_id']==706181)]
...
#measurement_2_positives_after_covid = measurement_2.query('measurement_date > "2019-11-17" and person_id in @person_ids_positives')

#measurement_2_positives_after_covid['counts'] = measurement_2_positives_after_covid.groupby('measurement_concept_id')['measurement_concept_id'].transform('count')
#measurement_2_positives_after_covid.sort_values('counts', inplace=True, ascending=False)
#measurement_positives_after_covid = measurement_positives_after_covid.query('counts > 15')
#measurement_2_positives_after_covid = measurement_2_positives_after_covid.drop_duplicates('measurement_concept_id')
#measurement_2_concept_ids_sorted_wrt_frequency = measurement_2_positives_after_covid['measurement_concept_id'].tolist()
#print(measurement_2_concept_ids_sorted_wrt_frequency)
...
#measurement_2_feature_concept_ids = measurement_2_concept_ids_sorted_wrt_frequency[0:100]
...
#measurement_2_feature_index = dict(zip(measurement_2_feature_concept_ids, range(len(measurement_2_feature_concept_ids))))
...
#n_measurement_2_types = len(measurement_2_feature_concept_ids)
#X_measurement_2 = np.zeros((len(person_index), n_measurement_2_types))
...
#for i in measurement_2_feature_concept_ids:
...
#dump(measurement_2_feature_concept_ids, measurement_2_concept_ids_filename)
...
#X_measurement_selected_2, best_n_features_selected_measurement_2 = feature_selection_auprc(X_measurement_2, Y)
