...
#n_features_first_part = X_selected.shape[1]
n_features_gender_race_ethnicity = X_gender_race_ethnicity.shape[1]
X_remain, X_opt, Y_remain, Y_opt = train_test_split(X, Y, test_size=0.25, stratify=Y)

X_selected = X_opt[:, 0:-n_features_gender_race_ethnicity]
X_gender_race_ethnicity = X_opt[:, -n_features_gender_race_ethnicity:]
...
arff_filename = "../model/train.arff"
npy_filename = "../model/train_gender_race_ethnicity.npy"

save_dataset_to_arff_file(X_selected, Y_opt, arff_filename)

npy_file = open(npy_filename, 'wb')
np.save(npy_file, X_gender_race_ethnicity)
