#performs 10-fold CV using logistic regression with 44 numeric features (measurement, condition, age) with class weights applied in balanced mode (increasing the weight of the minority class)
...
clf = LogisticRegression(solver='saga', class_weight='balanced').fit(X,Y)
