...
kde_zero = KernelDensity(kernel='gaussian', bandwidth=1.0).fit(X_selected_zero)
kde_one = KernelDensity(kernel='gaussian', bandwidth=1.0).fit(X_selected_one)

dump(kde_zero, '../model/conditional_density_zero')
dump(kde_one, '../model/conditional_density_one')
