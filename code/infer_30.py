...
drug_concept_ids_pas_filename = "../data/drug_concept_ids_pas.csv"

best_n_features_selected_measurement_filename = "../data/best_n_features_selected_measurement"
best_n_features_selected_condition_filename = "../data/best_n_features_selected_condition"
best_n_features_selected_observation_filename = "../data/best_n_features_selected_observation"
best_n_features_selected_device_exposure_filename = "../data/best_n_features_selected_device_exposure"
best_n_features_selected_drug_exposure_filename = "../data/best_n_features_selected_drug_exposure"
best_n_features_selected_procedure_filename = "../data/best_n_features_selected_procedure"
best_n_features_selected_visit_filename = "../data/best_n_features_selected_visit"

drug_concept_ids_pas_df = pd.read_csv(drug_concept_ids_pas_filename)
