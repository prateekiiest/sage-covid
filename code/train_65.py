...
def feature_selection_auprc(X, Y):
	...
	idx = CMIM.cmim(X_opt, Y_opt)
        ...
        X_selected = X[:, idx[0:best_n_features_selected]]
...
X_measurement_selected, idx_measurement = feature_selection_auprc(X_measurement, Y)
X_condition_selected, idx_condition = feature_selection_auprc(X_condition, Y)
X_observation_selected, idx_observation = feature_selection_auprc(X_observation, Y)
X_device_exposure_selected, idx_device_exposure = feature_selection_auprc(X_device_exposure, Y)
X_drug_exposure_selected, idx_drug_exposure = feature_selection_auprc(X_drug_exposure, Y)
X_procedure_selected, idx_procedure = feature_selection_auprc(X_procedure, Y)
X_visit_selected, idx_visit = feature_selection_auprc(X_visit, Y)
