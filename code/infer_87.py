...
best_feature_indices_selected_measurement_filename = "../../model/best_feature_indices_selected_measurement"
best_feature_indices_selected_measurement_2_filename = "../../model/best_feature_indices_selected_measurement_2"
best_feature_indices_selected_condition_filename = "../../model/best_feature_indices_selected_condition"
best_feature_indices_selected_observation_filename = "../../model/best_feature_indices_selected_observation"
best_feature_indices_selected_device_exposure_filename = "../../model/best_feature_indices_selected_device_exposure"
best_feature_indices_selected_drug_exposure_filename = "../../model/best_feature_indices_selected_drug_exposure"
best_feature_indices_selected_procedure_filename = "../../model/best_feature_indices_selected_procedure"
best_feature_indices_selected_visit_filename = "../../model/best_feature_indices_selected_visit"
...
best_feature_indices_selected_measurement = load(open(best_feature_indices_selected_measurement_filename, "rb"))
best_feature_indices_selected_measurement_2 = load(open(best_feature_indices_selected_measurement_2_filename, "rb"))
best_feature_indices_selected_condition = load(open(best_feature_indices_selected_condition_filename, "rb"))
best_feature_indices_selected_observation = load(open(best_feature_indices_selected_observation_filename, "rb"))
best_feature_indices_selected_device_exposure = load(open(best_feature_indices_selected_device_exposure_filename, "rb"))
best_feature_indices_selected_drug_exposure = load(open(best_feature_indices_selected_drug_exposure_filename, "rb"))
best_feature_indices_selected_procedure = load(open(best_feature_indices_selected_procedure_filename, "rb"))
best_feature_indices_selected_visit = load(open(best_feature_indices_selected_visit_filename, "rb"))
...
X_min_selected = X_min[:, best_feature_indices_selected_measurement]
X_max_selected = X_max[:, best_feature_indices_selected_measurement]
X_ave_selected = X_ave[:, best_feature_indices_selected_measurement]
...
X_measurement_selected_2 = X_measurement_2[:, best_feature_indices_selected_measurement_2]
X_condition_selected = X_condition[:, best_feature_indices_selected_condition]
X_observation_selected = X_observation[:, best_feature_indices_selected_observation]
X_device_exposure_selected = X_device_exposure[:, best_feature_indices_selected_device_exposure]
X_drug_exposure_selected = X_drug_exposure[:, best_feature_indices_selected_drug_exposure]
X_procedure_selected = X_procedure[:, best_feature_indices_selected_procedure]
X_visit_selected = X_visit[:, best_feature_indices_selected_visit]
