...
feature_indices_measurement = load(open(feature_indices_measurement_filename, "rb"))
feature_indices_condition = load(open(feature_indices_condition_filename, "rb"))
feature_indices_observation = load(open(feature_indices_observation_filename, "rb"))
feature_indices_device_exposure = load(open(feature_indices_device_exposure_filename, "rb"))
feature_indices_drug_exposure = load(open(feature_indices_drug_exposure_filename, "rb"))
feature_indices_procedure = load(open(feature_indices_procedure_filename, "rb"))
feature_indices_visit = load(open(feature_indices_visit_filename, "rb"))
...
X_measurement_selected = X_measurement[:, feature_indices_measurement]
X_condition_selected = X_condition[:, feature_indices_condition]
X_observation_selected = X_observation[:, feature_indices_observation]
X_device_exposure_selected = X_device_exposure[:, feature_indices_device_exposure]
X_drug_exposure_selected = X_drug_exposure[:, feature_indices_drug_exposure]
X_procedure_selected = X_procedure[:, feature_indices_procedure]
X_visit_selected = X_visit[:, feature_indices_visit]
