...
X_min_period_selected = X_min_period[:, 0:best_n_features_selected_measurement]
...
X_measurement_selected = np.concatenate((X_measurement_selected, X_min_period_selected), axis=1)
