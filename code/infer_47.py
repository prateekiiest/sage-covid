...
means_continuous = clf_continuous.theta_
variances_continuous = clf_continuous.sigma_
...
means_discrete = clf_discrete.theta_
variances_discrete = clf_discrete.sigma_
...
for i in range(len(person_ids)):
	...
	log_likelihoods_gaussian_continuous = compute_log_likelihoods_gaussian(X_continuous_selected_2_i, means_continuous, variances_continuous)
        log_likelihoods_gaussian_discrete = compute_log_likelihoods_gaussian(X_discrete_selected_2_i, means_discrete, variances_discrete)
	...
	likelihood_zero = log_likelihoods_gaussian_continuous[0] + log_likelihoods_gaussian_discrete[0] + math.log(class_priors[0])
	likelihood_one = log_likelihoods_gaussian_continuous[1] + log_likelihoods_gaussian_discrete[1] + math.log(class_priors[1])
