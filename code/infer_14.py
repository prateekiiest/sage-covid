...
measurement_concept_ids_file = open("../data/measurement_concept_ids.list", "r")
condition_concept_ids_file = open("../data/condition_concept_ids.list", "r")
observation_concept_ids_file = open("../data/observation_concept_ids.list", "r")
device_exposure_concept_ids_file = open("../data/device_exposure_concept_ids.list", "r")
drug_exposure_concept_ids_file = open("../data/drug_exposure_concept_ids.list", "r")
procedure_concept_ids_file = open("../data/procedure_concept_ids.list", "r")
visit_concept_ids_file = open("../data/visit_concept_ids.list", "r")
...
measurement_feature_concept_ids = pickle.load(measurement_concept_ids_file)
condition_feature_concept_ids = pickle.load(condition_concept_ids_file)
observation_feature_concept_ids = pickle.load(observation_concept_ids_file)
device_exposure_feature_concept_ids = pickle.load(device_exposure_concept_ids_file)
drug_exposure_feature_concept_ids = pickle.load(drug_exposure_concept_ids_file)
procedure_feature_concept_ids = pickle.load(procedure_concept_ids_file)
visit_feature_concept_ids = pickle.load(visit_concept_ids_file)
...
selectorfile = '../model/selector.sav'
selector = pickle.load(open(selectorfile, 'rb'))
