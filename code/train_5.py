#performs 10-fold CV using logistic regression with 44 numeric features (measurement, condition, age) and Z-score normalization applied to measurement and age features
