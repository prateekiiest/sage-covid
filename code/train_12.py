...
X = np.concatenate((X_measurement_selected, X_condition_selected), axis=1)
X = np.concatenate((X, X_age), axis=1)
X = np.concatenate((X, X_observation_selected), axis=1)
X = np.concatenate((X, X_device_exposure_selected), axis=1)
