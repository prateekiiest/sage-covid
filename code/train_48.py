...
clf_continuous = GaussianNB().fit(X_continuous_selected, Y)
clf_discrete = MultinomialNB().fit(X_discrete_selected, Y)

print(datetime.now())

dump(clf_continuous, '../model/baseline_continuous.joblib')
dump(clf_discrete, '../model/baseline_discrete.joblib')
