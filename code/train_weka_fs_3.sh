...
feature_selected_dataset_filename="${models_dir}train_fs_3.arff"
...
#${java_dir}java -classpath ${weka_dir}weka.jar weka.filters.supervised.attribute.AttributeSelection -E "weka.attributeSelection.WrapperSubsetEval -B weka.classifiers.bayes.NaiveBayes -F 3 -T 0.01 -R 1 -E AUPRC --" -S "weka.attributeSelection.BestFirst -D 2 -N 5" -i $dataset_filename -o $feature_selected_dataset_filename

${java_dir}java -classpath ${weka_dir}weka.jar weka.filters.supervised.attribute.AttributeSelection -E "weka.attributeSelection.WrapperSubsetEval -B weka.classifiers.bayes.NaiveBayes -F 2 -T 0.5 -R 1 -E AUPRC --" -S "weka.attributeSelection.GreedyStepwise -T -1.7976931348623157E308 -N -1 -num-slots 1" -i $dataset_filename -o $feature_selected_dataset_filename
