...
measurement_positives_after_covid = measurement.query('measurement_date > "2019-11-17" and person_id in @person_ids_positives and value_as_number != 0.0')
measurement_concept_ids_positives_after_covid = measurement_positives_after_covid['measurement_concept_id'].tolist()

measurement_negatives_after_covid = measurement.query('measurement_date > "2019-11-17" and person_id in @person_ids_negatives and measurement_concept_id in @measurement_concept_ids_positives_after_covid and value_as_number != 0.0')
...
transformer = Normalizer().fit(X_selected)
